...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Record /</span> DingConnect</h4>
                      ...
                      <div class="col-4 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h3 class="card-title text-nowrap mb-2">{{ $Ding['CurrencyIso']. ' '. $Ding['Balance'] }}</h3>
