              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="/send_airtime">
                        @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="country" class="select2 form-select" name="country_select">
                              <option value="">Select</option>
                              @foreach($CountryInfo as $country)
                              <option value="{{ $country->iso3 }}">{{ $country->name .' ('. $country->phonecode. ' )'  }}</option>
                              @endforeach
                            </select>
                            @error('country_select') <span class="text-danger text-sm"> {{ $message }}  </span>@enderror
                          </div>
                          <div class="mb-3 col-md-6">
                            ...
                            @error('mobileNumber') <span class="text-danger text-sm"> {{ $message }}  </span>@enderror
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="network" id="select_networkAirt">Network </label>
                            <select id="network_airtime" class="select2 form-select" name="network_airtime">
                              <option value="">Select</option>
                              
                            </select>
                            @error('network_airtime') <span class="text-danger text-sm"> {{ $message }}  </span>@enderror
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="input_amount" id="select_inputAmt">Input Amount</label>
                            <select id="input_amount" class="select2 form-select" name="input_amount"> 
                              <option value="">Select Input Amount</option>
                             
                            </select>
                            @error('input_amount') <span class="text-danger text-sm"> {{ $message }}  </span>@enderror
                          </div>
                          <div class="mb-3 col-md-12 d-none" id="loan_term_box">
                            <label class="form-label" for="country">Select Loan Term (days)</label>
                            <select id="country" class="select2 form-select" name="loan_term">
                              <option value="">-- --</option>
                        ...
                        <div class="mb-3 col-md-6 d-none" id="modileNetworkDetaile">
                          <div class="row">
                            <div class="col-md-3">
                              <span> 
                                <img id="network_logo" src="" alt="" class="responsive-img" style="width:80%; height:15vh">
                            </span>
                            </div>
                            <div class="col-md-10">
                              <p>
                                ...
                                <div class="form-group" style="display: none">
                                  <label> Amount in you currency: </label> 
                                  <input type="text" readonly id="estimated_Price" class="form-control">
