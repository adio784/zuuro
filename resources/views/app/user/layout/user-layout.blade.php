...
>
  <head>
    ...
    <link rel="stylesheet" href="/assets/css/demo_country.css" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('user-welcome') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo fw-bolder ms-2">QoinCo</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{('user-welcome')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{('/loan_summary')}}" class="menu-link">
                ...
                <div data-i18n="Boxicons">QoinCo Loan</div>
              </a>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ session('LoggedUserPicture') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{ session('LoggedUserFullName') }}</span>
                            <small class="text-muted">{{ session('LoggedUserEmail') }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
